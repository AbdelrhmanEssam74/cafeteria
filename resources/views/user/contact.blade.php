...
@section('styles')
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/user/contact.css') }}">
@endsection
@section('navbar')
...
@section('content')
    <!-- Start Hero Section -->
    <div class="hero " style="background-color: #f8f5f0;">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-6">
                    <div class="intro-excerpt">
                        <h1 style="color: #3a2e1f; font-weight: 700;">Visit Us Today</h1>
                        <p class="mb-4 lead" style="color: #6d5c4b;">We'd love to hear from you! Whether you have
                            questions
                            about our coffee, want to book an event, or just want to say hello, our team is ready to
                            assist
                            you.</p>
    ...
    <div class="untree_co-section bg-light py-5" id="contact-form">
        <div class="container mt-4">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center mb-5 mt-5">
                    <h2 class="section-title mb-3" style="color: #3a2e1f;">Get In Touch</h2>
                    <p class="lead" style="color: #6d5c4b;">Have questions about our coffee? Want to book an event?
                        We're
                        here to help!</p>
                </div>
            </div>
